            ...
            if ((i > 2)&&(i <= 7)) {
               ...
               if (c == '(') {
                  ...
                  if (set_x == FALSE) {
                     ...
                     err = find_label(c_str,&x,(label_typ ***)&next_pnt);  set_x = TRUE;
                     if (next_pnt == equ_pnt) {
                        undef_flag2 = TRUE;
                     }
...
int evalx(unsigned char *tmp2, unsigned char *gid, unsigned char *id, unsigned char *low, unsigned char *mid, unsigned char *high)
{

...
int set_reg_opecode(unsigned char a, unsigned char b, unsigned char c, unsigned char d)
{
   set_op(b);
   if (a > 1) { set_op(c); }
   if (a > 3) { set_op(d); }
...
unsigned char no_operand(unsigned char offset)
{
   set_op(offset);
   return 69;
}

int set_r3_opecode(unsigned char a, unsigned char b, unsigned char c)
{
   switch (a) {
...
int set_mn_opecode(unsigned char a, unsigned char b, unsigned char c, unsigned char d)
{
   switch (a) {
...
unsigned char two_operand(unsigned char typ, unsigned char offset, int *pnt)
{
...
unsigned char one_operand(unsigned char typ, unsigned char offset)
{
